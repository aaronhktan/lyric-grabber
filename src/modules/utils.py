...
#
# 2. For the application to be shown in the "Open With" submenu in the
#    right-click submenu:
#      _HKCR
#      └── _Local Settings
#          └── _Software
...
#                        └── MuiCache
#
#      - MuiCache must have the following values:
#        - REG_SZ (name_of_app.exe.ApplicationCompany) dev_name_here
#        - REG_SZ (name_of_app.exe.FriendlyAppName) name_of_app
#
#
...
#     Modify the plist file as follows:
...
#                <string>more_filetype</string>
#                <string>filetype_with_a_kick</string>
#              </array>
